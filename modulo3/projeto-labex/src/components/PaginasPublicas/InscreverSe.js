...
export default function InscreverSe() {
  ...
  const { form, onChange } = useForm({ 
    nome: "", idade: "", texto: "", profissao: "", pais: "" 
  })
  ...
  const cadastrando = (e) => {
    ...
    axios.post(`https://us-central1-labenu-apis.cloudfunctions.net/labeX/lais/trips/${form.viagem}/apply`, body)
      .then((res) => {
      ...
      .catch((error) => {
        ...
        alert('Dados incorretos. Necessário reenvio', error.response)
        navigate('/cadastro')
      })
  }
